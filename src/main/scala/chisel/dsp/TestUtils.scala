...
object TestUtils {
  ...
  def minValueOfSIntOfSize(numBits: Int): BigInt = {
    numBits match {
      case 0 => BigInt(0)
      case 1 => BigInt(-1)
      case _ => BigInt(-(1 << numBits))
    }
  }
  def maxValueOfSIntOfSize(numBits: Int): BigInt = {
    numBits match {
      case 0 => BigInt(0)
      case 1 => BigInt(0)
      case _ => BigInt((1 << numBits)-1)
    }
  }
